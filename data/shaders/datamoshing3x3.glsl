...
vec2 getFlow3x3(){
	...
	vec2 flow  = getFlow(vertTexCoord.xy + vec2(-1.0, -1.0) * texel) * 0.25;
		 flow += getFlow(vertTexCoord.xy + vec2( 0.0, -1.0) * texel) * 0.5;
		 flow += getFlow(vertTexCoord.xy + vec2( 1.0, -1.0) * texel) * 0.25;
		 flow += getFlow(vertTexCoord.xy + vec2(-1.0,  0.0) * texel) * 0.5;
